          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display mb-6">
                Automatización de{" "}
                <span className="text-gradient">facturas</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-8">
                Automatiza la gestión de facturas eliminando tareas manuales y
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="max-w-2xl mx-auto space-y-4 mb-16 text-lg text-muted-foreground">
                <p>
                  La automatización del procesamiento de facturas no solo ahorra
                  tiempo, sino que profesionaliza el control financiero de
                  cualquier empresa.
                </p>
                <p className="font-semibold text-foreground">
                  El objetivo es que el equipo se centre en el análisis, no en
                  la entrada de datos.
                </p>
              </div>
              ...
              <div className="max-w-4xl mx-auto bg-gradient-card border border-secondary/30 rounded-3xl p-10 shadow-elevated relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4">
                    ¿Quieres optimizar tu gestión de facturas?
                  </h3>
...
export default AutomatizacionFacturas;
