          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8">
                Elimina las llamadas y los errores manuales con un sistema de
                reservas 100% automatizado.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="max-w-2xl mx-auto space-y-4 mb-16 text-lg text-muted-foreground">
                <p>
                  Un sistema de reservas automatizado elimina la fricción entre
                  el cliente y el servicio. No solo reduce ausencias, sino que
                  permite una planificación óptima de los recursos.
                </p>
