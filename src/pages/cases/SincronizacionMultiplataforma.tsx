...
const SincronizacionMultiplataforma = () => {
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display mb-6">
                Sincronización{" "}
                <span className="text-gradient">multi-plataforma</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-8">
                Conecta todas tus herramientas y mantén tus datos sincronizados
                en tiempo real sin duplicidades.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="max-w-2xl mx-auto space-y-4 mb-16 text-lg text-muted-foreground">
                <p>
                  Eliminar los silos de información es vital para una toma de
                  decisiones ágil y acertada. Una sincronización robusta
                  garantiza que todos tus sistemas hablen el mismo idioma en
                  tiempo real.
                </p>
                <p className="font-semibold text-foreground">
                  La verdadera potencia tecnológica se alcanza cuando todas tus
                  herramientas trabajan como un único ecosistema coherente.
                </p>
              </div>
...
export default SincronizacionMultiplataforma;
