          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-display mb-6">
                Alertas y <span className="text-gradient">notificaciones</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-8">
                Mantén el control total de tu negocio con alertas automáticas
                basadas en eventos clave.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="max-w-2xl mx-auto space-y-4 mb-16 text-lg text-muted-foreground">
                <p>
                  El control proactivo es la clave de la eficiencia empresarial.
                  Recibir información crítica en tiempo real permite reaccionar
                  antes de que los problemas escalen, manteniendo la operativa
                  siempre bajo control.
                </p>
                <p className="font-semibold text-foreground">
                  No se trata de recibir más avisos, sino de recibir la
                  información correcta en el momento exacto para actuar.
                </p>
              </div>
              ...
              <div className="max-w-4xl mx-auto bg-gradient-card border border-secondary/30 rounded-3xl p-10 shadow-elevated relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4">
                    ¿Quieres mejorar tu control operativo?
                  </h3>
